Turnkey wordpress is a small shell script that can turn a [turnkey linux](https://www.turnkeylinux.org/) and prolly every debian linux machine into a wordpress server,
...
You will be requested to enter some additional info for the certificates.
